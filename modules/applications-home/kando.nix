            ...
            children = [
              ...
              }
              {
                ...
                children = [
                  ...
                  {
                    type = "command";
                    data.command = "kando --reload-menu-theme";
                    name = "Reload Menu Theme";
                    icon = "refresh";
                    iconTheme = "material-symbols-rounded";
                  }
                  {
                    type = "command";
                    data.command = "xdg-open ~/.config/kando";
              ...
              }
              {
                ...
                children = [
                  ...
                  {
                    type = "command";
                    data.command = "systemctl suspend";
                    name = "Suspend";
                    icon = "bedtime";
                    iconTheme = "material-symbols-rounded";
                  }
